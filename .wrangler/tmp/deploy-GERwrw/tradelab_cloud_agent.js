(() => {
  ...
  // tools/tradelab_cloud_agent.js
  var require_tradelab_cloud_agent = __commonJS({
    "tools/tradelab_cloud_agent.js"(exports, module) {
      var BOT_TOKEN = typeof globalThis !== "undefined" && globalThis.TELEGRAM_BOT_TOKEN || typeof process !== "undefined" && process.env && process.env.TELEGRAM_BOT_TOKEN || "";
      var CHAT_ID = typeof globalThis !== "undefined" && globalThis.TELEGRAM_CHAT_ID || typeof process !== "undefined" && process.env && process.env.TELEGRAM_CHAT_ID || "";
      var GITHUB_RAW = "https://raw.githubusercontent.com/Youjin-led/TradeLab/main";
      var SYMBOLS = ["BTCUSDT", "ETHUSDT", "SOLUSDT", "BNBUSDT", "XRPUSDT", "DOGEUSDT", "ADAUSDT", "LINKUSDT", "AVAXUSDT", "SUIUSDT", "LTCUSDT", "NEARUSDT"];
      ...
      __name(fetchBinancePrices, "fetchBinancePrices");
      async function fetchFearGreed() {
        ...
        return data.data.map((d) => ({
          ...
          timestamp: parseInt(d.timestamp) * 1e3
        }));
      }
      __name(fetchFearGreed, "fetchFearGreed");
      ...
      __name(fetchFundingRates, "fetchFundingRates");
      ...
      __name(analyzeSymbol, "analyzeSymbol");
      async function collectAllData() {
        ...
        return {
          _collectedAt: (/* @__PURE__ */ new Date()).toISOString(),
          prices,
          fearGreed,
          funding,
          market,
      ...
      __name(collectAllData, "collectAllData");
      ...
      __name(formatMarketOverview, "formatMarketOverview");
      ...
      __name(scheduledHourly, "scheduledHourly");
      ...
      __name(getStoredData, "getStoredData");
        ...
        try {
          ...
          switch (text) {
            case "/status":
              ...
              break;
            case "/market":
              response = await handleMarket();
              break;
            case "/signals":
              response = await handleSignals();
              break;
            case "/trades":
  ...
  require_tradelab_cloud_agent();
})();
//# sourceMappingURL=tradelab_cloud_agent.js.map
