(() => {
  ...
  var require_tradelab_telegram_webhook = __commonJS({
    "tools/tradelab_telegram_webhook.js"(exports, module) {
      var BOT_TOKEN = typeof globalThis !== "undefined" && globalThis.env ? globalThis.env.TELEGRAM_BOT_TOKEN : typeof process !== "undefined" && process.env && process.env.TELEGRAM_BOT_TOKEN || "";
      var CHAT_ID = typeof globalThis !== "undefined" && globalThis.env ? globalThis.env.TELEGRAM_CHAT_ID : typeof process !== "undefined" && process.env && process.env.TELEGRAM_CHAT_ID || "";
