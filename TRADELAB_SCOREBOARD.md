...
NEARUSDT:4h:breakout | 55% | watch | Blocked | 485 | 33 | +912.18 | 0.00 | 0.00% | 0 | status is incubating, expected ready-for-review
INJUSDT:4h:sma-rsi | 53% | improving | Blocked | 446 | 29 | +1177.91 | 0.46 | 8.18% | 3 | status is incubating, expected ready-for-review
DOGEUSDT:4h:sma-rsi | 53% | watch | Blocked | 540 | 12 | +137.90 | 0.00 | 0.00% | 0 | status is incubating, expected ready-for-review
ARBUSDT:4h:breakout | 51% | deteriorating | Healthy | 86 | 3 | +271.65 | 1.05 | 2.96% | 3 | status is incubating, expected ready-for-review
ETHUSDT:4h:sma-rsi | 50% | watch | Blocked | 434 | 9 | -219.69 | 0.00 | 0.00% | 0 | status is incubating, expected ready-for-review
...
NEARUSDT:1d:sma-rsi | 44% | watch | Blocked | 252 | 4 | +6.32 | 0.00 | 0.00% | 0 | status is incubating, expected ready-for-review
FILUSDT:4h:sma-rsi | 44% | deteriorating | Blocked | 214 | 4 | -259.99 | 0.00 | 0.00% | 0 | status is incubating, expected ready-for-review
...
LINKUSDT:4h:breakout | 35% | deteriorating | Blocked | 124 | 8 | -18.71 | 0.65 | 5.50% | 5 | status is incubating, expected ready-for-review
TRXUSDT:4h:sma-rsi | 33% | collecting | Blocked | 86 | 2 | +0.70 | 0.58 | 1.82% | 5 | status is incubating, expected ready-for-review
...
--- | ---: | --- | ---: | ---
ATOMUSDT:1h:sma-rsi | 26% | deteriorating | +87.77 | status is incubating, expected ready-for-review; health is Blocked, expected Healthy; forward paper trades 3 < 15; profit factor 0.42 < 1.6; loss streak 5 > 2
OPUSDT:1h:sma-rsi | 29% | collecting | +60.45 | status is incubating, expected ready-for-review; health is Blocked, expected Healthy; forward paper trades 2 < 15; profit factor 0.47 < 1.6; loss streak 6 > 2
SEIUSDT:1h:breakout | 31% | deteriorating | -142.21 | status is incubating, expected ready-for-review; health is Blocked, expected Healthy; forward paper trades 7 < 15; profit factor 0.37 < 1.6; loss streak 7 > 2
AVAXUSDT:1h:breakout | 32% | deteriorating | +227.69 | status is incubating, expected ready-for-review; health is Blocked, expected Healthy; forward paper trades 4 < 15; profit factor 0.66 < 1.6; loss streak 5 > 2
...
LINKUSDT:4h:breakout | 35% | deteriorating | -18.71 | status is incubating, expected ready-for-review; health is Blocked, expected Healthy; forward paper trades 8 < 15; profit factor 0.65 < 1.6; loss streak 5 > 2
BCHUSDT:1h:sma-rsi | 35% | watch | +14.77 | status is incubating, expected ready-for-review; health is Blocked, expected Healthy; forward paper trades 3 < 15; profit factor 0.69 < 1.6
DOTUSDT:4h:breakout | 36% | deteriorating | -138.56 | status is incubating, expected ready-for-review; health is Blocked, expected Healthy; forward paper trades 6 < 15; profit factor 0.8 < 1.6; loss streak 3 > 2
